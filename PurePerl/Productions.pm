...
[\x{1FD6}-\x{1FDB}] | [\x{1FE0}-\x{1FEC}] | [\x{1FF2}-\x{1FF4}] | [\x{1FF6}-\x{1FFC}] | \x{2126}
| [\x{212A}-\x{212B}] | \x{212E} | [\x{2180}-\x{2182}] | [\x{3041}-\x{3094}] |
[\x{30A1}-\x{30FA}] | [\x{3105}-\x{312C}] | [\x{AC00}-\x{D7A3}]
    /x;

    $Extender = qr/
\x{00B7} | \x{02D0} | \x{02D1} | \x{0387} | \x{0640} | \x{0E46} | \x{0EC6} | \x{3005} |
